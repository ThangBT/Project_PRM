...
public class PaymentActivity extends AppCompatActivity {
    ...
    private String merchantCode = "MOMO0PCT20190322";
    private String merchantNameLabel = "ABC";
    private String description = "Thanh toan dich vu";
    ...
    private void requestPayment() {
        ...
        eventValue.put(MoMoParameterNamePayment.PARTNER_CODE, "MOMO0PCT20190322");
